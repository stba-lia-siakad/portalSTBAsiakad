                            ...
                            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $product->jam ?>
                                        </td>
                                        <td>
                                            <?php echo $product->hari ?>
                                        </td>
                                        <td>
                                            <?php echo $product->ruang ?>
                                        </td>
                                        
                                        
                                        <td>
                                            <a href="<?php echo site_url('admin/products/edit/'.$product->id_jadwal) ?>"
                                             class="btn btn-small"><i class="fas fa-edit"></i></a>
                                            <a onclick="deleteConfirm('<?php echo site_url('admin/products/delete/'.$product->id_jadwal) ?>')"
